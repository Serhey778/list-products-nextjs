        ...
        <div className="relative mt-2 rounded-md">
          <div className="relative">
            <select
              id="product_id"
              name="product_id"
              className="peer block w-full bg-white cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue=""
            ...
            <ShoppingCartIcon className="pointer-events-none absolute left-3 top-1/2 h-[25px] w-[25px] -translate-y-1/2 text-green-800" />
          </div>
        </div>
      </div>
